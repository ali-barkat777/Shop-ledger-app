...
@Autowired
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addProduct(@RequestBody ProductDto productDto,@RequestParam String userId){
        ...
        ResponseEntity<?> products = productService.addPrd(userId,productDto);
