...
public class ReceiptService {
  ...
  @Autowired
   ...
   //create receipts
   public ResponseEntity<?> createReceipt(List<String> productIds,int discount,String customer,Charge charge) {
       ...
       try {
           ...
           for (String productId : productIds) {
               ...
               if (product != null) {
                   ...
                   ReceiptProduct receiptProduct = new ReceiptProduct(product.getPrdName(), product.getPrice());
           ...
           if (discount > 0 && discount < 100) {
               ...
               double discountTotal = totalAmount - discountAmount;
           ...
           //Card Charge
               if (charge == Charge.BYCARD){
                   ...
                   System.out.println("please enter the payment method correct");
               }
